...
#t::
	If (WinExist("ahk_exe clion64.exe")) {
		...
		Run, %A_StartMenu%\Pkg\CLion 2021.2.1.lnk, C:/
...
#s::
	If (WinExist("ahk_exe salamand.exe")) {
		...
		Run, D:\_custom\keyboard_remap\app\ahk\old/../../data/shortcuts/Altap Salamander (x64).lnk, C:/
...
#a::
	If (WinExist("ahk_exe VmConnect.exe")) {
		...
		Run, D:\_custom\keyboard_remap\app\ahk\old/../../data/shortcuts/Hyper-V Manager.lnk, C:/
...
#j::
	If (WinExist("ahk_exe Signal.exe")) {
		...
		Run, D:\_custom\keyboard_remap\app\ahk\old/../../data/shortcuts/Signal.lnk, C:/
...
#c::
	If (WinExist("ahk_exe Spotify.exe")) {
		...
		Run, D:\_custom\keyboard_remap\app\ahk\old/../../data/shortcuts/Spotify.lnk, C:/
...
#m::
	If (WinExist("ahk_exe msedge.exe")) {
		...
		Run, D:\_custom\keyboard_remap\app\ahk\old/../../data/shortcuts/Microsoft Edge.lnk, C:/
...
#n::
	If (WinExist("ahk_exe Typora.exe")) {
		...
		Run, D:\_custom\keyboard_remap\app\ahk\old/../../data/shortcuts/Typora.lnk, C:/
